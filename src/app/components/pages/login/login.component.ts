...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private apiauthenticationService: ApiauthenticationService, private route: ActivatedRoute, private msalService: MsalService) { }
